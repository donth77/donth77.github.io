...
$(function() {
    ...
    function displayResults(data) {
        ...
        $("#results").html("<h1>" + data.original_title + "(" + year + ")" + "</h1>" +
            "<h2>" + data.tagline + "</h2>" +
            "<br><div class='embed-container'><iframe src='http://www.youtube.com/embed/" + data.trailers.youtube[0].source +
